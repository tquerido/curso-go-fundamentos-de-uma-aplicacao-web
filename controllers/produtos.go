...
import (
	"curso-go-fundamentos-de-uma-aplicacao-web/models"
	"log"
	"net/http"
	"strconv"
	"text/template"
...
func Update(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		models.AtualizaProduto(idConvertidaParaInt, quantidadeConvertidaParaInt, nome, descricao, precoConvertidoParaFloat)
	}
